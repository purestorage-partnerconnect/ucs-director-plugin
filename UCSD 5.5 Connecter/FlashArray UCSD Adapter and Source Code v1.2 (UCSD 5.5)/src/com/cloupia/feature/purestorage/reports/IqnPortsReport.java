...
public class IqnPortsReport extends CloupiaReportWithActions
{

    private static Logger logger = Logger.getLogger(IqnPortsReport.class);

    public IqnPortsReport()
    {
        super();
    ...
    {
        return IqnPortsReportImpl.class;
    }

    @Override
    public String getReportLabel()
    {
        return "IQN Target Ports";
    }

    @Override
    public String getReportName()
    {
        return "com.purestorage.flasharray.iqnports";
    }
    ...
    {
        return PureConstants.IQN_REPORT_MENU_LOCATION;
    }
