...
public class PureStorageModule extends AbstractCloupiaModule
{
    ...
    {
        CloupiaReport[] reports = new CloupiaReport[7];
    ...
    public void onStart(CustomFeatureRegistry cfr)
    {
        try
        {
            ...
            String fieldName = "pure_port_tabular_provider";//your tabel name
			...
			sampleInputType.addDeclaration(new WorkflowInputFieldTypeDeclaration(
		                "Pure FlashArray Target Port Multiinput", "Pure FlashArray Target Port Multiinput",
		                FormFieldDefinition.FIELD_TYPE_TABULAR,fieldName, true));
    ...
    private void createFlashArrayAccountType() throws Exception
    {
        ...
        entry.setPodTypes(new String[]{"FlashStack"});
