    ...
    public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception
    {
        ...
        if(truncate)
        {
            try{
            	...
            	String description="Account Name = "+config.getAccountName()+" , Volume Name = "+ volumeName+" , Volume Size = "+originSize;
                
                UcsdCmdbUtils.updateRecord("FlashArray Volume", description, 0, context.getUserId(), volumeName,description);
                
                context.getChangeTracker().resourceAdded("FlashArray Volume", volIdentity, volumeName, description);
